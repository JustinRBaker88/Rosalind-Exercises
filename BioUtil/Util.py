rna_translation     =  {"UUU" : "F", "UUC" : "F", "UUA" : "L", "UUG" : "L",
...
dna_translation     =  {"TTT" : "F", "TTC" : "F", "TTA" : "L", "TTG" : "L",
...
def rna_codon_to_protein(codon: str):
    try:
        return rna_translation[codon]
    except:
        return " ERROR, INVALID CODON "
    
def dna_codon_to_protein(codon: str):
    try:
        return dna_translation[codon]
    except:
        return " ERROR, INVALID CODON "
...
def is_common_substring(search_substring, all_strings):
    ...
    return True
def get_blosum62():
    return { ('W', 'F'): 1, ('L', 'R'): -2, ('S', 'P'): -1, ('V', 'T'): 0, 
